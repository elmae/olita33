...
<nav id="main-nav" class="navbar navbar-expand-lg sticky-top bg-*" aria-labelledby="main-nav-label">
  ...
  <div class="<?php echo esc_attr( $container ); ?>">
    ...
    <div class="offcanvas offcanvas-end bg-warning bg-opacity-75" tabindex="-1" id="navbarNavOffcanvas">
      ...
      <!-- Navbar brand -->
      <!-- Your site branding in the menu -->
      <span class="text-center navbar-brand py-3 mt-2 mt-lg-0 d-md-none">
        <?php get_template_part( 'global-templates/navbar-branding' ); ?>
      </span>
